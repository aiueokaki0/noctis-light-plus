...
`Noctis Light Plus` は、Noctis 系を参考にした Light テーマを追加する VS Code 用カラーテーマ拡張です。ローカルでの試用や調整、見た目の検証を目的としています。
...
既存の Noctis ファミリーが持つ読みやすいシンタックス配色を保ちつつ、色相ごとに UI の印象を変えた Light バリアントとして構成しています。

## 収録テーマ

### Noctis Rose

やわらかいローズトーンを基調にした Light テーマです。暖かいピンク系アクセントと落ち着いた中立色を組み合わせています。

### Noctis Verdant

みずみずしいグリーントーンを基調にした Light テーマです。緑系アクセントを持たせつつ、Noctis らしいコントラストを維持しています。
